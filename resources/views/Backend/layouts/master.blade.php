...
<head>
    ...
    <!-- App css -->
    <link href="{{asset('Frontend\css\fcss\all.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('Backend/sweetalert2/sweetalert2.min.css')}}" rel="stylesheet" type="text/css">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                ...
                                <span class="account-user-avatar">
                                    <img src="{{(!empty(Auth::user()->image))?asset('upload_img/'.Auth::user()->image):asset('upload_img/no_img.png')}}" alt="user-image"
                                        class="rounded-circle">
                                </span>
                                <span>
                                    <span class="account-user-name">{{ Auth::user()->name }}</span>
                                    <span class="account-position">
                                        {{(Auth::user()->userType == 'SAdmin')?'Supper Admin':''}} 
                                        {{(Auth::user()->userType == 'manager')?'Manager':''}} 
                                        {{(Auth::user()->userType == 'normal')?'Normal User':''}}</span>
                                </span>
                            </a>
                            <div
