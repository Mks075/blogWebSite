...
<div class="container-fluid my-3">
    <div class="card col-12">
        <div class="card-body">
            ...
            <h1 class="header-title float-start col-10 mx-0">Manage Mission </h1>
            <a href="{{route('mission.view')}}" class="col-2 btn btn-light">
                        <i class="mdi mdi-account-edit me-1"></i> View Mission List</a>
            </div> <!-- end col-->
            <form id="myForm" action="{{route('mission.store')}}" method="post" enctype="multipart/form-data" class="needs-validation mx-auto">
                {{csrf_field()}}
                <div class="col-sm-12">
                ...
                <br>
                <input type="submit" class="btn btn-success" value="Submit Mission">
            </form>
        </div><!-- end col-->
    </div>
</div>
